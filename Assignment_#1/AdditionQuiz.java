...
public class AdditionQuiz {
    ...
    public static void main(String[] args) {
        System.out.println();
		String taskDetail = """
							Task 1: Expand Characters in a String [Input : a1b4c3 , Output : abbbbccc],
							Task 2: Character Frequency in a String [Input : aabcccdeee , Output : a2b1c3d1e3],
							Task 3: Prime Number Checker  [Input : 21 , Output : The given number is NOT prime],
							Task 4: Number to Words Converter [Input :  51 , Output : fifty one],
							Task 5: Longest Substring Without Repeating Character [Input : abcabcbb , Output : 3], """;
        ...
        switch (number) {
            case 1:
                ...
                System.out.println(expandCharacters(task1));
                break;

            case 2:
                System.out.print("Enter a data : ");
                String task2 = sc.nextLine();
                System.out.println(getfre(task2));
                break;
            ...
            case 4:
                ...
                if (sc.hasNextInt()) {
                    ...
                    System.out.println(InStrng(task4));
            ...
            case 5:
                ...
                System.out.println(maxlen(task5));
                break;
    ...
    public static String getfre(String userInput) { // find the Char frequency
        String answer = "";
        int i = 0;
